...
class CordisSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        if response.xpath('//*[@id="ica:content"][contains(.,"water") or contains(.,"drinking")]') and response.xpath('(.//*[@id="dynamiccontent"]/div[2]/text()[2])[contains(.,"2012")]'): # response.xpath('//*[@id="dynamiccontent"]/div[3]/div/div[2]/div[3]/text()[contains(.,"SME")]'): # and response.css('.name').xpath('text()[contains(.,"RENEW TECHNOLOGIES LTD")]'):
            item = CordisItem()
